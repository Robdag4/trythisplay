...
import { A as AstroError, v as UnknownContentCollectionError, c as createComponent, w as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, x as renderUniqueStylesheet, y as renderScriptElement, z as createHeadAndContent, r as renderComponent } from './astro/server_ukkwF2dm.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_39cGVSm2.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Uk4agskr.mjs').then(n => n._);
